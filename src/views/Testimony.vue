        ...
        <div v-for="(item, key) in testimonies" class="col-lg-2 col-sm-12 col-md-4 mb-4" v-bind:key="item">
            <div :key="key" class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <d-button disabled theme="secondary" outline class="btn-success mr-1"><i :class="item.t_status?'fa fa-eye':'fa fa-eye-slash'"></i>
                        </d-button>
                        <div class="d-flex justify-content-end">
                            <d-button theme="secondary" class="btn-white mr-1">Share <i class="fa fa-share-alt"></i>
                            </d-button>
                            <d-button v-on:click="deleteTest(item.t_id)" theme="danger" outline class="btn-danger mr-1"><i class="fa fa-times"></i>
                            </d-button>
                        </div>
                    </div>
                </div>
        ...
        <d-form class="p-3" onsubmit="return false">
            <d-form-row>
                <d-col class="form-group" md="12">
                    ...
                    <d-form-input v-model="fdata.tname" type="text" id="feInputAddress" placeholder="Testifier's Name" />
                </d-col>
                <d-col class="form-group" md="12">
                ...
                <d-col md="12" class="form-group">
                    ...
                    <d-textarea maxlength="1000" v-model="fdata.tdesc" class="form-control" id="desc" rows="5"></d-textarea>
                </d-col>
            </d-form-row>
            <d-form-row>
                <div class="d-flex justify-content-between w-100">
                    <d-button v-on:click="hide" size="sm" outline theme="danger" class="mb-2 ml-1">Cancel <i class="fa fa-times"></i>
                    </d-button>
                    <d-button v-on:click="addTestimony" size="sm" theme="secondary" class="mb-2 mr-1">Submit Now <i class="fa fa-paper-plane"></i></d-button>
                </div>
            </d-form-row>
        </d-form>
    </modal>
